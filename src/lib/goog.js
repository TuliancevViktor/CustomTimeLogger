...
const CLIENT_ID = '1081598936294-j9kbg60ges43t6126hvd9qrf3fqg3539.apps.googleusercontent.com';
 ...
 */
export function logTime(spreadsheetId, start, end, client, module, treatmentType,
                        label, what, clientOptions, moduleOptions, treatmentTypeOptions) {
  return gapi.client.sheets.spreadsheets.values.append({
    spreadsheetId,
    valueInputOption: 'USER_ENTERED',
    range: TIME_RANGE,
    values: [[start, end, client, module, treatmentType,
      label, what, clientOptions, moduleOptions, treatmentTypeOptions]],
  }).then(id, checkError);
}
